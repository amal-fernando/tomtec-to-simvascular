...
surface_mesh = pv.read(vtx, np.hstack((np.full((connectivity.shape[0], 1), 3), connectivity)).astype(np.int64))
...
# Save volume mesh
output_file = os.path.join(output_dir, f"mesh_{surface_mesh}.vtk")
